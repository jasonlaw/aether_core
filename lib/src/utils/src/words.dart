...
const String _diaCriticalMark =
    r'\u0300-\u036F\u1AB0-\u1AFF\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F';

const String _lowerCase =
...
const String _digit = r'\d';

const String _dingbatBlock = r'\u2700-\u27BF';

const String _nonChar = r'\x00-\x2F\x3A-\x40\x5B-\x60\x7b-\xBF\xD7\xF7';

const String _generalPunctuation = r'\u2000-\u206F';

const String _whiteSpace =
    r'\t-\r \x85\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000';

const String _word =
    '(?:[$_upperCase][$_diaCriticalMark]*)?(?:[$_lowerCase][$_diaCriticalMark]*)+|(?:[$_upperCase][$_diaCriticalMark]*)+(?![$_lowerCase])|[$_digit]+|[$_dingbatBlock]|[^$_nonChar$_generalPunctuation$_whiteSpace]+';

String camelCaseToWords(String subject,
    {String separator = " ", Pattern customPattern = defaultPattern}) {
  if (subject.isEmpty) {
    return '';
  }
...
const String defaultPattern = _word;
